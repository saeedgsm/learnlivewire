...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "MaxBuy" => "حداکثر خرید",
        "MinBuy" => "حداقل خرید",
        "MaxPoint" => "حداکثر تعداد",
        "MinPoint" => "حداقل تعداد",
        "siteName" => "نام سایت",
        "partnerCode" => "کد سایت همکار",
        "siteLink" => "لینک سایت",
        "fromHour" => "از ساعت",
        "toHour" => "تا ساعت",
        "startDay" => "شروع روز",
        "endDay" => "پایان روز",
        "orderLimited" => "سفارش محدود روزانه",
        "minPercent" => "حداقل درصد سود",
        "maxPercent" => "حداکثر درصد سود",
        "deliveryDay" => "تاریخ تحویل",
        "deliveryTime" => "زمان تحویل",
        "level" => "سطح",
        "percent" => "درصد",
        "role" => "وظیفه",
        "prefix__open_time__suffix" => "زمان شروع کار",
        "prefix__close_time__suffix" => "زمان پایان کار",
        "turn_type" => "نوع نوبت دهی",
        "branch_code" => "کد شعیه",
        "business_id" => "کسب و کار",
        "sub_business_id" => "زیر کسب و کار",
        "user_id" => "کاربر",
        "unit" => "واحد",
        "plaque" => "پلاک",
        "permission" => "مجوز",
        ...
        "endDateTurns" => "تاریخ پایان نوبت دهی",
        "person_code" => "کد پرسنلی",
        "display_name" => "نام نمایشی ",
        "count" => " تعداد",
        "code" => " کد تخفیف",
        "altFromDate" => "تاریخ شروع",
        "altToDate" => " تاریخ پایان",
        "field_name" => " نام فیلد",
        "field_help" => " توضیحات فیلد",
        "field_parts" => " قسمت فیلد",
